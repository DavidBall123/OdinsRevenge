...
namespace OdinsRevenge
{
    ...
    public class ParticleSystem : UC_Renderable
    {
        Random rnd;
        public Texture2D tex { set; get; }
        // public bool active; moved to renderable
        ...
        public ParticleSystem(Vector2 posZ, int MaxnumZ, int ticksSystemDurationZ)
        {
            rnd = new Random();
            active = false;
            generation = false;
